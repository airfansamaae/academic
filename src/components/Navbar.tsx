        ...
        <div className="flex items-center justify-between h-16 sm:h-18">
          ...
          <div className="hidden md:flex items-center space-x-3 text-xs text-slate-500 bg-slate-50/80 border border-slate-200/90 px-3.5 py-1.5 rounded-full">
            <div className="flex items-center space-x-1.5 text-emerald-600 font-medium">
              ...
              <span>ระบบเชื่อมต่อฐานข้อมูลและพื้นที่จัดเก็บพร้อมใช้งาน</span>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2 sm:space-x-3">
            {currentUser ? (
              <>
                {/* User Info Geometric Capsule */}
                <div className="flex items-center space-x-2.5 bg-slate-50 hover:bg-slate-100 border border-slate-200 pl-2 pr-3 py-1.5 rounded-xl transition-colors">
                  <img
                    src={currentUser.avatarUrl}
                    alt={currentUser.fullName}
                    className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg object-cover ring-1 ring-purple-500/20"
                    onError={(e) => {
                ...
                <button
                  ...
                  className="flex items-center space-x-1.5 px-3 py-1.5 sm:py-2 text-xs font-medium text-slate-600 bg-slate-100 hover:bg-slate-200 rounded-lg transition-colors cursor-pointer"
                >
                ...
                <button
                  ...
                  onClick={onLogout}
                  title="ออกจากระบบ"
                  className="flex items-center space-x-1.5 px-3 py-1.5 sm:py-2 text-xs font-medium text-rose-600 bg-rose-50 hover:bg-rose-100 rounded-lg transition-colors cursor-pointer"
                >
              ...
              <button
                id="btn-navbar-login"
                onClick={onOpenAuth}
                className="btn-glow-purple flex items-center space-x-2 px-4 py-2 text-xs sm:text-sm font-bold text-white bg-purple-600 hover:bg-purple-700 rounded-xl transition-all cursor-pointer"
              >
